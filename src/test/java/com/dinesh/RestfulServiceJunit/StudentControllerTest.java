package com.dinesh.RestfulServiceJunit;
...
import com.dinesh.RestfulServiceJunit.controller.StudentController;
...
public class StudentControllerTest {
	...
	@Test
	public void retrieveDetailsOfCourse_withMokito() throws Exception {
	...
	public void createCourseForStudent_withMockito() throws Exception
	{
		Course mockCourse = new Course("1", "Spring", "10 Steps",
				Arrays.asList("Learn Maven", "Import Project", "First Example", "Second Example"));
